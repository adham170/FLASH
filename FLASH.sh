...
install() {
echo -e "\033[0;36m"
echo -e "~ Welcome To Source FLASH - اهلا بك في سورس فلاش ~"
...
wget "apiADHAM.ml/installubuntu18/compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb" && sudo dpkg -i compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb
...
echo -e "|-------------------------------------------|"
echo -e "|This Source Was Developed By (ADHAM) @Q_Y_4.|"
echo -e "|  This Is The Source Channel @FAQY4 .   |"
echo -e "|               - FLASH -                 |"
echo -e "---------------------------------------------"
echo -e "\033[0m"
